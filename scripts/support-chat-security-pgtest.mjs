...
const repair = readFileSync(new URL('../supabase/migrations/20260924083204_repair_support_bot_service_identity.sql', import.meta.url), 'utf8');
...
await db.exec(`GRANT SELECT, INSERT ON public.chat_messages TO authenticated, service_role;
