...
export const SkeletonText = ({ lines = 3, width = '100%' }) => (
  <div className="skeleton-text-group" role="status" aria-busy="true" aria-label="Loading text content">
...
export const SkeletonCard = () => (
  <div className="skeleton-card" role="status" aria-busy="true" aria-label="Loading content card">
    <div className="skeleton-card-header" aria-hidden="true">
    ...
    <div className="skeleton-card-body" aria-hidden="true">
