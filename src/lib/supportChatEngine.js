 ...
 * a new conversation.
 */
export const createConversationContext = (userId, conversationId = null) => ({
...
export const resetConversationContext = (context, userId = null, conversationId = null) => {
...
export const summarizePaymentActivity = (payments = [], refunds = []) => {
