-- ============================================================================
-- Harden customer-triggered admin notifications
-- ============================================================================
-- The browser uses this RPC after a booking or feedback submission. The old
-- function accepted arbitrary text from any authenticated customer, allowing
-- admin-feed spam and convincing internal-looking messages. The caller now
-- proves ownership of the referenced record and the server builds the text.
